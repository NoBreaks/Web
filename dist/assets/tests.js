...
define('nobreaks/tests/components/safe-image.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | components/safe-image.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'components/safe-image.js should pass jshint.');
  });
});
...
define('nobreaks/tests/routes/raiding/roster.jshint', ['exports'], function (exports) {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'routes/raiding/roster.js should pass jshint.\nroutes/raiding/roster.js: line 17, col 16, \'Promise\' is not defined.\n\n1 error');
  });
});
