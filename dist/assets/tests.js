...
define('nobreaks/tests/routes/raiding/mythic/progress.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint | routes/raiding/mythic/progress.js');
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'routes/raiding/mythic/progress.js should pass jshint.');
  });
});
